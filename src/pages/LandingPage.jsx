...
import { Lock, ArrowRight, Mail, Key, UserPlus, ChevronRight, GraduationCap, Building2, UserCircle, Check, Loader2 } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
            ...
            <motion.div 
                ...
                className="w-full md:w-3/5 bg-[#0A1F3C] text-white p-8 md:p-16 flex flex-col justify-center relative overflow-hidden"
            >
                ...
                <div className="relative z-10">
                    ...
                    {/* Tricolor Bar */}
                    <div className="w-24 h-1 bg-gradient-to-r from-[#FF9933] via-white to-[#138808] rounded-full mb-12" />

                    <div className="text-sm text-gray-500 font-medium tracking-widest uppercase">
            ...
            <motion.div 
                ...
                className="w-full md:w-2/5 p-8 md:p-12 flex flex-col items-center bg-[#F8FAFC]"
            >
                <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100 relative mt-[8vh]">
                    <div className="mb-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Institutional Access</h2>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors mb-6"
                    >
                        <img 
                    ...
                    <div className="relative flex items-center mb-6">
                        ...
                        <span className="flex-shrink mx-4 text-xs text-gray-400 font-bold uppercase tracking-widest">Or Direct Access</span>
                        <div className="flex-grow border-t border-gray-200"></div>
                    </div>
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-[#FF9933] focus:border-transparent outline-none transition-all text-gray-800"
                                required
                            />
                        </div>
                        ...
                        <div>
                            <div className="flex justify-between mb-2">
                                ...
                                <a href="#" className="text-xs font-bold text-[#FF9933] hover:underline">
                                    Forgot Password?
                                </a>
                            </div>
                            <input
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#FF9933] text-white py-3 rounded-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-[1px] active:translate-y-0 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
